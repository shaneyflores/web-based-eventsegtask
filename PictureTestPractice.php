...
<script type="text/javascript" src="PictureTestPractice.js"></script>
...
<form id="mturk_form" action="PictureTest.php" method="post">
...
<p id="instructions" align="center">You will now see pairs of pictures. Each pair will contain one picture
taken from one of the movies you saw and one picture taken from similar movies, but not the ones you saw. 
Your task is to identify the picture in each pair that came from one of the movies you saw as
...
We will have you first do a short practice test to familiarize you with the task. <br><br>

Please ensure the above rectangle is completely visible and fits in your browser window before beginning. <br><br>
 
When you are ready to begin, push the "Start Practice" button to start the practice test.<br><br></p>
